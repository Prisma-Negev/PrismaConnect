-- Combined PrismaConnect Migrations
-- Generated: 2026-03-15T21:24:13Z

-- ===========================================
-- Migration: 20240730075029_init_db.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20240730075425_init_triggers.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20240806124555_task_sales_id.sql
-- ===========================================
alter table "public"."tasks" add column "sales_id" bigint;

-- ===========================================
-- Migration: 20240807082449_remove-aquisition.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20240808141826_init_state_configure.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20240813084010_tags_policy.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20241104153231_sales_policies.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20250109152531_email_jsonb.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20250113132531_phone_jsonb.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20251204172855_merge_contacts_function.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20251204201317_drop_merge_contacts_function.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260108160722_task_default_sales.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260115150819_snake_case_renaming.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260127140209_imports.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260128165057_sso_handling.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260211194545_app_configuration.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260226163952_deals_expected_closing_date_date_only.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260304104600_note_attachments_trigger.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260307120000_nb_tasks_pending_only.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260309112831_fix_security_warnings.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260314120000_activity_log_view.sql
-- ===========================================
...
-- ===========================================
-- Migration: 20260315120000_prisma_negev_customization.sql
-- ===========================================
